...
function MastersIcon({ color = '#4A90D9', size = 32 }) {
  return (
          ...
          <Reveal delay={100}>
            <div className="space-y-5">
              <div className="flex gap-4 items-start p-4 rounded-xl" style={{ background: isDark ? 'rgba(0,0,0,0.2)' : 'rgba(74,144,217,0.04)' }}>
                <MastersIcon color="#4A90D9" size={28} />
                <div>
                  <h3 className="font-serif font-bold text-[18px] mb-1" style={{ color: text }}>Research-Intensive & Global</h3>
                  <p className="text-[15px]" style={{ color: sub }}>Germany's master's programmes are world-class, globally respected, and largely free.</p>
                </div>
              </div>
              <div className="flex gap-4 items-start p-4 rounded-xl" style={{ background: isDark ? 'rgba(0,0,0,0.2)' : 'rgba(74,144,217,0.04)' }}>
                ...
                <div>
                  ...
                  <p className="text-[15px]" style={{ color: sub }}>Wrong tier, weak SOP, late APS, missed deadlines — we fix what consultancies get wrong.</p>
                </div>
              </div>
              <div className="flex gap-4 items-start p-4 rounded-xl" style={{ background: isDark ? 'rgba(0,0,0,0.2)' : 'rgba(74,144,217,0.04)' }}>
                ...
                <div>
                  ...
                  <p className="text-[15px]" style={{ color: sub }}>We identify programmes where you are genuinely competitive and build your documents properly.</p>
                </div>
              </div>
            </div>
          </Reveal>
