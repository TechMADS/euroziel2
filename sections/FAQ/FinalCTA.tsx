      ...
      <Reveal>
        <div className="rounded-3xl px-8 py-16 relative overflow-hidden" style={{
          ...
          <div className="relative z-10">
            <p className="text-[13px] font-semibold uppercase tracking-widest mb-5" style={{ color: '#0f4c8f' }}>Still Have Questions?</p>
            <h2 className="font-serif font-bold mb-5 leading-tight" style={{ fontSize: 'clamp(28px, 4.5vw, 42px)', color: text }}>
              Get a free consultation
              <br />
              <span style={{ color: '#f59e0b' }}>tailored to your profile.</span>
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="https://wa.me/917598969875" target="_blank" rel="noopener noreferrer" className="rounded-full px-8 py-4 text-[16px] font-semibold transition-all duration-200 flex items-center gap-2" style={{ background: '#25D366', color: '#fff', boxShadow: '0 4px 20px rgba(37,211,102,0.32)' }} onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.transform = 'translateY(-2px)'; }} onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.transform = 'translateY(0)'; }}>
